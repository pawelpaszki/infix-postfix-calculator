...
public class UserInterface implements ActionListener {
	...
	/**
	 * this method changes the appearance of the passed textField:
	 * sets background to black, applies font properties, size and
	 * centres the text inside the textField (textField becomes uneditable - 
	 * only by pressing buttons the value can be input into it)   
	 * @param textfield
	 */
	 ...
	 * calcEngine tries to evaluate the expression and as long as it is 
	 * valid - it will evaluate it and the result will be printed along with 
	 * the expression in postfix notation. C clears both textFields. other buttons
